...
var __pygwt_modController = {
	...
	desenha: function(module, qtd) {
        this._onEvent('ddd', module, qtd)
    }
}
...
function __pygwt_earlyUser() {
    ...
    splash.style = function() {
        ...
        splash.infoCont.style.width = '100%'//'40%'
        ...
        splash.progressBar.style.height = '38px'
        splash.progressBar.style.lineHeight = '38px'
        splash.progressBar.style.fontSize = '0px'
        splash.progressBar.style.maxHeight = '38px'
        splash.progressBar.style.width = '0px'
        splash.progressBar.style.backgroundColor = '#CCC'
        splash.status.style.marginTop = '6px'
        splash.status.style.fontFamily = 'sans'
        splash.status.style.fontWeight = 'bold'
		splash.status.style.width = '100%'
    }
	...
	d = function(module, qtd) { 
		mod.started = qtd; 
		mod.loaded++; 
		draw.exec(true);
	}
	__pygwt_modController.addListener('ddd', d)
	//$wnd['__pygwt_modController']['desenha'](i, module_list['length'])
