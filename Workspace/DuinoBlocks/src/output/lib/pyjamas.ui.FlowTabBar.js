...
$pyjs['loaded_modules']['pyjamas.ui.FlowTabBar'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('insertTab', function(text, asHTML, beforeIndex) {
			...
			if ($p['bool']($p['isinstance'](text, $p['basestring']))) {
				if ($p['bool'](asHTML)) {
					item = $m['HTML'](text);
				}
				else {
	...
	, 1, [null,null,['self'],['text'],['asHTML'],['beforeIndex', null]]);
		...
		$method = $pyjs__bind_method2('insertTabWidget', function(widget, beforeIndex) {
			...
			self['panel']['insert'](delWidget, self['panel']['getElement'](), $p['__op_add']($add3=beforeIndex,$add4=1));
			parent = $m['DOM']['getParent'](delWidget['getElement']());
			self['setStyleName'](parent, $p['__op_add']($add5=$p['getattr'](self, 'STYLENAME_DEFAULT'),$add6='-wrapper'), true);
			return null;
		}
	...
	, 1, [null,null,['self'],['sender', null]]);
		...
		$method = $pyjs__bind_method2('removeTab', function(index) {
			...
			var toRemove,$add8,$add7;
			self['checkTabIndex'](index);
			toRemove = self['panel']['getWidget']($p['__op_add']($add7=index,$add8=1));
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('selectTab', function(index) {
			...
			var $iter2_nextval,$iter2_type,$iter2_iter,$iter3_array,listener,$iter2_idx,$iter3_idx,$add10,$iter3_iter,$iter3_type,$add9,$iter3_nextval,$iter2_array;
			self['checkTabIndex'](index);
			...
			self['selectedTab'] = self['panel']['getWidget']($p['__op_add']($add9=index,$add10=1));
