/* start module: edu.uca.renderable.argument.DropdownStringArgument */
$pyjs['loaded_modules']['edu.uca.renderable.argument.DropdownStringArgument'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['edu.uca.renderable.argument.DropdownStringArgument']['__was_initialized__']) return $pyjs['loaded_modules']['edu.uca.renderable.argument.DropdownStringArgument'];
	...
	var $m = $pyjs['loaded_modules']['edu.uca.renderable.argument.DropdownStringArgument'];
	$m['__repr__'] = function() { return '<module: edu.uca.renderable.argument.DropdownStringArgument>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'edu.uca.renderable.argument.DropdownStringArgument';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['edu.uca.renderable.argument']['DropdownStringArgument'] = $pyjs['loaded_modules']['edu.uca.renderable.argument.DropdownStringArgument'];


	$m['StringArgument'] = $p['___import___']('edu.uca.renderable.argument.StringArgument.StringArgument', 'edu.uca.renderable.argument', null, false);
	...
	$m['drawDropdownStringArgument'] = function(s, v, b, i) {
	...
	$m['drawDropdownStringArgument']['__name__'] = 'drawDropdownStringArgument';

	$m['drawDropdownStringArgument']['__bind_type__'] = 0;
	$m['drawDropdownStringArgument']['__args__'] = [null,null,['s'],['v'],['b'],['i']];
	$m['DropdownStringArgument'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'edu.uca.renderable.argument.DropdownStringArgument';
		$method = $pyjs__bind_method2('__init__', function(values, block) {
			...
			$m['StringArgument']['__init__'](self);
			$m['MouseHandler']['__init__'](self);
			self['values'] = values;
			self['block'] = block;
			self['input']['setReadonly'](true);
			$m['drawDropdownStringArgument'](self, $p['getattr'](self, 'values'), $p['getattr'](self, 'ButtonDown'), $p['getattr'](self, 'ItenClick'));
	...
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			$m['StringArgument']['onBrowserEvent'](self, event);
	...
	, 1, [null,null,['self'],['value']]);
		...
		$method = $pyjs__bind_method2('getArgumentValue', function() {
			...
			if ($p['bool'](!$p['bool']($p['op_eq'](self['input']['getText'](), '')))) {
	...
	, 1, [null,null,['self'],['value']]);
		...
		var $bases = new Array($m['StringArgument'],$m['MouseHandler']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('DropdownStringArgument', $p['tuple']($bases), $data);
	})();
	return this;
}; /* end edu.uca.renderable.argument.DropdownStringArgument */


/* end module: edu.uca.renderable.argument.DropdownStringArgument */


/*
PYJS_DEPS: ['edu.uca.renderable.argument.StringArgument.StringArgument', 'edu', 'edu.uca', 'edu.uca.renderable', 'edu.uca.renderable.argument', 'edu.uca.renderable.argument.StringArgument', 'pyjamas.ui.MouseListener.MouseHandler', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.MouseListener', 'edu.uca.renderable.Element.Element', 'edu.uca.renderable.Element', 'pyjamas.ui.RootPanel.RootPanel', 'pyjamas.ui.RootPanel', 'pyjamas.ui.Event.ONMOUSEDOWN', 'pyjamas.ui.Event', 'pyjamas.DOM', 'edu.uca.ui.listener.MenuItenListener.MenuItenListener', 'edu.uca.ui', 'edu.uca.ui.listener', 'edu.uca.ui.listener.MenuItenListener', 'edu.uca.ui.listener.MenuButtonListener.MenuButtonListener', 'edu.uca.ui.listener.MenuButtonListener']
*/
